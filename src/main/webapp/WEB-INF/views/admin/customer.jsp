        ...
        <body>
            ...
            <div class="main-content">
                ...
                <main>
                    ...
                    <div class="but-ed">
                        <a href="${pageContext.request.contextPath}/admin/customer/new"><button class="new-button las la-plus">Thêm</button></a>
                        <a href="${pageContext.request.contextPath}/admin/customer"><button class="reload-button las la-sync">Reload</button></a>
