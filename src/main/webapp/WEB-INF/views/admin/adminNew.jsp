    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            ...
            <div class="main-content">
                ...
                <main>
                    <h2>New Account Admin</h2>
                    <div class="but-ed">
                        <a href="${pageContext.request.contextPath}/admin/admin"><button class="new-button las la-undo">Return</button></a>
                        <!-- <a href="#"><button class="delete-button lar la-trash-alt">Delete</button></a> -->
                    </div>
                    <div class="status">
                        <div class="forms-status">
                            <div class="form-infor">
                                <form action="${pageContext.request.contextPath}/admin/admin/new" method="post">
                                    <label for="username">Tên đăng nhập</label><br>
                                    <input name="userName" type="text" id="username" placeholder="...123450"><br><br>

                                    <label for="password">password</label><br>
                                    <input name="password" type="text" id="password" placeholder="...012345"><br><br>
