        ...
        <body>
            ...
            <div class="main-content">
                ...
                <main>
                    <h2>New Inventory</h2>
                    <div class="but-ed">
                        <a href="${pageContext.request.contextPath}/admin/category"><button
                    ...
                    <form action="${pageContext.request.contextPath}/admin/category/edit" method="post"
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <th class="thimg"><img src="${pageContext.request.contextPath}/resources/IMG/category/${bookCategory.img}" alt="img demo"></th>
                                    <th>${bookCategory.name}</th>

                            
                                </tr>
                                <tr>
                                    <input type="hidden" name="imgName" value="${bookCategory.img}">
                                    <input type="hidden" name="id" value="${bookCategory.id}">
                                    <th><input type="file" name="img"></th>
                                    <th><input type="text" name="name" value="${bookCategory.name}"></th>
