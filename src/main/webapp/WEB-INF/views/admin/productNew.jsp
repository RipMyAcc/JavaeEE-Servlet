        ...
        <body>
            ...
            <div class="main-content">
                ...
                <main>
                    <h2>New Products</h2>
                    <div class="but-ed">
                        <a href="${pageContext.request.contextPath}/admin/product"><button class="new-button las la-undo">Return</button></a>
                        <!-- <a href="#"><button class="delete-button lar la-trash-alt">Delete</button></a> -->
                    </div>
                    <div class="status">
                        <div class="forms-status">
                            <div class="form-infor">
                                <form action="${pageContext.request.contextPath}/admin/product/new" method="post" enctype="multipart/form-data">
                                    <label for="">Links Img</label><br>
                                    <input name="img" type="file"><br>
                                    <label for="">Name</label><br>
                                    <input name="name" type="text" placeholder="...books"><br><br>
                                    <label for="">book category</label><br>
                                    <input name="category" type="text" placeholder="...books"><br><br>
                                    <label for="">book description</label><br>
                                    <input name="description" type="text" placeholder="...books"><br><br>
                                    <label for="">Money</label><br>
                                    <input name="price" type="number" placeholder="...123450"><br><br>
                                    <label for="">Books quantity</label><br>
                                    <input name="amount" type="number" placeholder="...012345"><br><br>
